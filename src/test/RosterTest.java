...
public class RosterTest {
    ...
    private static void printPersonsOlderThan(List<Person> roster, int age) {
        roster.stream().filter((Person p) -> p.getAge() >= age).forEach(Person::printPerson);
    }
    ...
    private static void printPersonsWithinAgeRange(
        ...
        roster.stream().filter(p -> low <= p.getAge() && p.getAge() < high).forEach(Person::printPerson);
    }
...
//        }
    ...
    private static void printPersonsWithPredicate(
        ...
        roster.stream().filter(tester).forEach(tester::test);
//        for (Person p : roster) {
//            if (tester.test(p)) {
//                p.printPerson();
//            }
